...
**This bot is fully functional and ready to use but it only works if https://github.com/ChristianGrieger/Cryptocurrency-crypto-bot is installed as first layer and this bot as second layer.**  
